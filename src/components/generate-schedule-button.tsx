...
import { generateCategorySchedule } from '@/app/admin/temporadas/actions'

export function GenerateScheduleButton({ seasonId, categoryId }: { seasonId: string; categoryId: string }) {
  ...
  async function handleClick() {
    setLoading(true)
    setMessage(null)
    const result = await generateCategorySchedule(seasonId, categoryId)
